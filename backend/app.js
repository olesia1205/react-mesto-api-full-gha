...
app.use(cors({ origin: ['http://localhost:3000', 'http://localhost:3001', 'http://api.mesto.olerastova.nomoredomains.monster/sign-up', 'http://api.mesto.olerastova.nomoredomains.monster'] }));
// app.use(cors());
app.options('*', cors());
